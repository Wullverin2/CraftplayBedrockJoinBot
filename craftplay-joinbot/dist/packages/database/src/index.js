...
exports.bootstrapSchema = exports.connectDb = void 0;
const promise_1 = __importDefault(require("mysql2/promise"));
const connectDb = (cfg) => promise_1.default.createPool({ host: cfg.host, port: cfg.port, user: cfg.username, password: cfg.password, database: cfg.database, waitForConnections: true, connectionLimit: cfg.pool.max });
exports.connectDb = connectDb;
const bootstrapSchema = async (db) => {
    const ddl = [
